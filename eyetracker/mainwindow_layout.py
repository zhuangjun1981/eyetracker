...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox_pupil.setGeometry(QtCore.QRect(820, 230, 211, 191))
        ...
        self.groupBox_led.setGeometry(QtCore.QRect(820, 10, 211, 201))
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(820, 430, 211, 251))
        ...
        self.graphicsView_img.setGeometry(QtCore.QRect(10, 90, 801, 591))
        self.graphicsView_img.setObjectName("graphicsView_img")
        self.FrameSlider = QtWidgets.QSlider(self.centralwidget)
        self.FrameSlider.setEnabled(False)
        self.FrameSlider.setGeometry(QtCore.QRect(10, 700, 581, 31))
        ...
        self.pushButton_pauseplay.setGeometry(QtCore.QRect(740, 690, 50, 50))
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("res/pause.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.pushButton_saveConfig.setGeometry(QtCore.QRect(860, 690, 50, 50))
        ...
        self.pushButton_loadConfig.setGeometry(QtCore.QRect(800, 690, 50, 50))
        ...
        self.pushButton_process.setGeometry(QtCore.QRect(980, 690, 50, 50))
        ...
        self.pushButton_showResult.setGeometry(QtCore.QRect(920, 690, 51, 51))
        self.pushButton_showResult.setText("")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("res/eye.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.groupBox_movieInfo.setGeometry(QtCore.QRect(10, 10, 801, 71))
        ...
        self.label_movieInfo = QtWidgets.QLabel(self.groupBox_movieInfo)
        self.label_movieInfo.setGeometry(QtCore.QRect(10, 40, 71, 21))
        self.label_movieInfo.setObjectName("label_movieInfo")
        ...
        self.label_movieInfoValue = QtWidgets.QLabel(self.groupBox_movieInfo)
        self.label_movieInfoValue.setGeometry(QtCore.QRect(80, 40, 711, 20))
        self.label_movieInfoValue.setObjectName("label_movieInfoValue")
        self.lineEdit_frameNum = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit_frameNum.setEnabled(False)
        self.lineEdit_frameNum.setGeometry(QtCore.QRect(602, 689, 131, 51))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.lineEdit_frameNum.setFont(font)
        self.lineEdit_frameNum.setAlignment(QtCore.Qt.AlignCenter)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("res/load.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_pupilBinary.setText(_translate("MainWindow", "Binary Thresh"))
        self.label_pupilMinSize.setText(_translate("MainWindow", "Min Size"))
        self.label_pupilROI.setText(_translate("MainWindow", "ROI"))
        self.label_pupilBlur.setText(_translate("MainWindow", "Blur"))
        self.label_pupilOpenClose.setText(_translate("MainWindow", "Open Close"))
        ...
        self.label_ledBlur.setText(_translate("MainWindow", "Blur"))
        self.label_ledOpenClose.setText(_translate("MainWindow", "Open Close"))
        self.label.setText(_translate("MainWindow", "Mask dilation"))
        self.label_ledBinary.setText(_translate("MainWindow", "Binary Thresh"))
        self.label_led_min.setText(_translate("MainWindow", "Min Size"))
        self.label_ledROI.setText(_translate("MainWindow", "ROI"))
        self.label_ledMaxSize.setText(_translate("MainWindow", "Max Size"))
        ...
        self.label_movieInfo.setText(_translate("MainWindow", "Frame info:"))
        self.label_moviePathValue.setText(_translate("MainWindow", "None"))
        self.label_movieInfoValue.setText(_translate("MainWindow", "None"))
        self.lineEdit_frameNum.setText(_translate("MainWindow", "0"))
